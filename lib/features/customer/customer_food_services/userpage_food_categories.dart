...
class _CategoriesPageState extends State<CategoriesPage> {
  ...
  Future<void> _fetchCategories() async {
    ...
    try {
      ...
      final categories = await ApiService().fetchCategoriesByRestaurantId(widget.restaurantId!);
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: Card(
              ...
              child: ListTile(
                leading: _getCategoryIcon(category.restaurantMenuCategoryName),
                title: Text(
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (context) => Subcategories(
                        restaurantMenuCategoriesId: category.restaurantMenuCategoriesId,roomNo: widget.roomNo,userName: widget.userName,
                        userId: widget.userId,floorId: widget.floorId,
                      ),
                    ),
                  );
                },
